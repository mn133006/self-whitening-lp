...
export function StoreInfo() {
  return (
    <section className="store lp-section lp-section--tint" aria-labelledby="store-title" id="access">
      <div className="lp-section__inner store__inner">
        ...
        <div className="store__layout">
          ...
          <figure className="store__photo">
            <img
              ...
              src="/section-store-visual.svg"
              alt="CLEAR ROUTINEの店舗案内とアクセスを表すイラスト"
              width={960}
              height={640}
              loading="lazy"
              decoding="async"
            />
            <figcaption className="store__photo-cap lp-caption">ご来店前にLINEで空き状況をご確認ください</figcaption>
          </figure>
        </div>
      </div>
    </section>
